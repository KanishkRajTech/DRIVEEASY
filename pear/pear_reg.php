...
if (isset($_POST['dealerRegistration'])) {
    ...
    $qry = "INSERT INTO `dealer`(`dealer_fname`, `dealer_lname`, `dealer_email`, `dealer_phone`,`dealer_pasword`) VALUES ('$firstName', '$lastName', '$email', '$phone','$password')";
...
<section class="min-h-screen bg-gradient-to-br from-blue-50 to-gray-100 py-12 px-4 sm:px-6 lg:px-8">
    <div class="max-w-xl mx-auto">
        ...
        <div class="text-center mb-10">
            ...
            <h2 class="text-3xl font-extrabold text-gray-900">Dealer Registration</h2>
            <p class="mt-2 text-sm text-gray-600">
                Join our network of trusted vehicle dealers
            </p>
        </div>

        <!-- Card Container -->
        <div class="bg-white w-full py-8 px-8 shadow-xl rounded-xl sm:px-12">
            <form id="dealerRegistrationForm" action="pear_reg.php" method="POST" class="mb-0 space-y-6">
                <?php 
                    if(!empty($msg)){
                        echo  $msg ;
                    }
                ...
                <!-- Submit Button -->
                <div>
                    <button type="submit" name="dealerRegistration"
